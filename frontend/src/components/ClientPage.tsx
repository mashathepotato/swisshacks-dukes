    ...
    <div className="clientpage">
      <div className="clientpage-inner">
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", gap: 16 }}>
          ...
          {onSimulate && (
            <button className="cp-rehearse" onClick={() => onSimulate(mergedClient)}>Rehearse a proposal →</button>
          )}
        </div>
        ...
        <div className="cp-toprow">
          <div className="cp-toprow-col"><PriorityScore client={mergedClient} /></div>
          <div className="cp-toprow-col"><LearningPanel client={mergedClient} /></div>
        </div>
        ...
        <div className="cp-grid">
          <div className="cp-col">
            ...
            <div className="kv" style={{ marginTop: 12 }}><span className="k">Mandate</span><span>{mergedClient.mandate}</span></div>
