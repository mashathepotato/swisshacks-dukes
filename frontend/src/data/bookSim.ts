...
export const ADVICE: Advice[] = [
  {
    ...
    weights: { us_tech_bullish: -1, defensive: 0.5, income: 0.4 },
    targetRisk: 35,
  },
  {
    id: "boost_ai",
    ...
    weights: { us_tech_bullish: 1, defensive: -0.6, income: -0.4 },
    targetRisk: 80,
  },
  {
    id: "green_bonds",
    ...
    weights: { environmental: 1, income: 0.2 },
    targetRisk: 30,
  },
  {
  ...
  },
  {
    ...
    weights: { income: 1, defensive: 0.6, us_tech_bullish: -0.4 },
    targetRisk: 30,
  },
];
