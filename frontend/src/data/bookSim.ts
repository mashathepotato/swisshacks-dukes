...
export const ADVICE: Advice[] = [
  {
    ...
    weights: { "tech-innovation": -1, consumer: 0.5, financials: 0.4 },
    targetRisk: 35,
  },
  {
    id: "boost_ai",
    ...
    weights: { "tech-innovation": 1, consumer: -0.6, financials: -0.4 },
    targetRisk: 80,
  },
  {
    id: "green_bonds",
    ...
    weights: { environment: 1, financials: 0.2 },
    targetRisk: 30,
  },
  {
  ...
  },
  {
    ...
    weights: { financials: 1, consumer: 0.6, "tech-innovation": -0.4 },
    targetRisk: 30,
  },
];
